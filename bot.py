...
listapregs= open("quest.json")
datos= json.load(listapregs)
for i in datos["Secciones"]:
    print(i)
...
def start(update: Update, context: CallbackContext) -> None:
    ...
    keyboard = [
        [
            InlineKeyboardButton("opcioon", callback_data='1'),
...
def main() -> None:
    ...
    updater = Updater("1937480308:AAFxyIBYa9awX4anvEaET-ipS87JDUxU16o")
